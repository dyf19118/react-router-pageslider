...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsTransitionGroup = __webpack_require__(223);

	var _reactAddonsTransitionGroup2 = _interopRequireDefault(_reactAddonsTransitionGroup);

	var _reactRouterPageslider = __webpack_require__(230);

	var _reactRouterPageslider2 = _interopRequireDefault(_reactRouterPageslider);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PageSlider = (0, _reactRouterPageslider2.default)();
		...
		render: function render() {
			return(
				...
				_react2.default.createElement(
					'div',
					{ className: 'page', id: 'page1' },
					_react2.default.createElement(
						_reactRouter.Link,
						{ className: 'link', to: '/page2' },
						'page2'
					),
					_react2.default.createElement(
						_reactRouter.Link,
						{ className: 'link', to: '/page3' },
						'page3'
					)
				)
			);
	...
	var Page2 = _react2.default.createClass({
		...
		render: function render() {
			return(
				...
				_react2.default.createElement(
					'div',
					{ className: 'page', id: 'page2' },
					_react2.default.createElement(
						_reactRouter.Link,
						{ className: 'link', to: '/page1' },
						'page1'
					),
					_react2.default.createElement(
						_reactRouter.Link,
